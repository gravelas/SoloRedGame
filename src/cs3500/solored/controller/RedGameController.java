...
public interface RedGameController {
  ...
  /**
   * Given the following parameters, plays a game of SoloRed. Will provide feedback on invalid moves and commands.
   * Additionally, the input will filter out Strings when there should be numbers negative numbers in general.
   ...
   * @throws IllegalArgumentException If something is wrong with the model, either its null or startGame doesn't work.
